...
const Login = () => {
    ...
    return (
        <div className='text-white py-20 md:min-h-auto pb-5 min-h-197 container mx-auto'>
            <h1 className="text-center font-bold md:text-3xl text-2xl p-4">Login to get started</h1>

            <div className="flex flex-col gap-2 items-center justify-center p-10">


                <button
                    className="flex items-center cursor-pointer  border border-gray-300 w-64 rounded-lg shadow-md max-w-xs px-7 py-3 text-sm font-medium text-white hover:bg-gray-700 bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
